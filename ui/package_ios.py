...
# Form implementation generated from reading ui file 'package_ios.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_7.setGeometry(QtCore.QRect(100, 70, 221, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "xcode配置", None))
        self.label_2.setText(_translate("Dialog", "xcode签名", None))
        self.label_3.setText(_translate("Dialog", "xcode依赖路径", None))
        self.label_12.setText(_translate("Dialog", "xcode版本", None))
        self.comboBox_7.setItemText(0, _translate("Dialog", "release", None))
        self.comboBox_7.setItemText(1, _translate("Dialog", "debug", None))
        self.groupBox_2.setTitle(_translate("Dialog", "xcode", None))
        self.label_4.setText(_translate("Dialog", "xcode项目", None))
