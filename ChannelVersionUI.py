...
# Form implementation generated from reading ui file 'ChannelVersionUI.ui'
#
...
#                                     "QListWidget::item:selected:enabled{background-color:gray;}"
#                                     "QListWidget::item:selected:!enabled{background:transparent;}"
#                                     "QListWidget::item:hover:enabled{background-color:gray;}"
#                                     )
...
#         self.pushButton_2.clicked.connect(self.updateChannelVersionLabel)
    
    
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Form", None))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">可选用SDK版本</span></p></body></html>", None))
...
class ChannelVersionListUI(QDialog,Ui_Form):  
    def __init__(self,parent=None):  
        super(ChannelVersionListUI,self).__init__(parent)  
